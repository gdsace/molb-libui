...
var header = (React.createElement("div", null,
    React.createElement(Icon, { type: "clock", size: "16" }),
    " I'm the header of this card"));
...
storiesOf(CategoryName.Cards, module).addWithJSX("Card", wInfo("")(function () { return (React.createElement("div", { style: { padding: "10px" } },
    ...
    React.createElement("div", { style: rowStyles },
        React.createElement(Card, { header: header, title: title, subtitle: subtitle, description: description, supportingText: price, theme: CardTheme.Normal })))); }));
