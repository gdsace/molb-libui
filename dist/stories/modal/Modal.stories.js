...
storiesOf(CategoryName.Modal, module).addWithJSX("Modal", wInfo("")(function () { return (React.createElement("div", null,
    ...
    React.createElement("div", { className: styles.container },
        React.createElement(State, { store: store6 },
            React.createElement(Modal, { key: "modal-6", theme: ModalTheme.Basic, show: !!store6.get("show"), onClose: function () { return store6.set({ show: false }); }, customIcon: React.createElement(Icon, { type: "progress", className: styles.progressIcon }) },
                React.createElement(ModalContent, { header: "This is Header of Modal Content.", subheader: "This is Sub Header of Modal Content" }))),
        React.createElement(Button, { label: "Modal with custom icon", onClick: function () { return store6.set({ show: true }); }, key: "modal-button1" })))); }));
