...
storiesOf(CategoryName.Modal, module).addWithJSX("ModalContent", wInfo("")(function () { return (React.createElement("div", null,
    ...
    React.createElement("div", { className: styles.box },
        React.createElement(ModalContent, { notification: "This is very long notification. This is very long notification. This is very long notification. important things need to repeat at least 3 times. And this is just description with a new font size 20px.", rightButtonLabel: "Right Button", rightButtonOnClick: action("right-button-click") })))); }));
