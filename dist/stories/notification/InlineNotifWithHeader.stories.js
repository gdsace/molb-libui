...
storiesOf(CategoryName.Notification, module).addWithJSX("InlineNotificationWithHeader", wInfo("")(function () {
    return (React.createElement("div", null,
        ...
        React.createElement("div", { style: { padding: "10px" } },
            ...
            React.createElement(InlineNotificationWithHeader, { header: "A very very very very very very very very long header", text: lorem, theme: NotificationTheme.Informational }),
            React.createElement("br", null),
