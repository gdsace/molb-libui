...
storiesOf(CategoryName.TextFields, module).addWithJSX("Input", wInfo("")(function () { return (React.createElement("div", { className: styles.rootContainer },
    ...
    React.createElement("div", { className: styles.itemsContainer },
        React.createElement("div", { className: styles.box },
            React.createElement(Input, { onChange: action("value"), type: InputType.IntegerText, placeholder: placeholder, label: "Integer", size: Size.Large, maxLength: 10 })),
        React.createElement("div", { className: styles.box },
            React.createElement(Input, { onChange: action("value"), type: InputType.PositiveIntegerText, placeholder: placeholder, label: "PositiveInteger", size: Size.Large, maxLength: 10 })),
        React.createElement("div", { className: styles.box },
