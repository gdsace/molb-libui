...
storiesOf(CategoryName.Others, module).addWithJSX("SubFormSection", wInfo("")(function () {
    return (React.createElement("div", null,
        ...
        React.createElement("div", { className: styles.box },
            React.createElement(SubFormSection, { id: "operatingHoursSubSection", title: "This is a collapsible sub-section", isCollapsible: true, theme: SubFormSectionTheme.Normal },
                React.createElement("p", null, "Theme: Normal, Some sample content"))),
        React.createElement("div", { className: styles.box },
            React.createElement(SubFormSection, { id: "operatingHoursSubSection", title: "This is a collapsible sub-section", isCollapsible: true, theme: SubFormSectionTheme.Normal, tooltip: "This is tooltip" },
                React.createElement("p", null, "Theme: Normal, Some sample content")))));
}));
