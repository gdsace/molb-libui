...
var CheckboxTypeQuestion = /** @class */ (function (_super) {
    ...
    CheckboxTypeQuestion.prototype.render = function () {
        var _a = this.props, checked = _a.checked, disabled = _a.disabled, questionLabel = _a.questionLabel, questionDescription = _a.questionDescription, tooltip = _a.tooltip, hidden = _a.hidden, errorMsg = _a.errorMsg;
        if (hidden) {
        ...
        return (React.createElement("div", { className: styles.wrapper },
            ...
            React.createElement("div", { className: styles.textWrapper + " " + (disabled ? styles.disabled : "") },
                ...
                errorMsg && (React.createElement("span", { className: styles.errorContainer },
                    React.createElement(Icon, { type: "notification-error", size: "14" }),
