    ...
    ActionSection.prototype.render = function () {
        ...
        return (React.createElement("section", { className: styles.section + " " + sectionClassName },
            React.createElement("div", { className: rowStyle },
                ...
                this.props.showNext && (React.createElement(Button, { className: styles.nextButton, label: this.props.onNextLabel ? this.props.onNextLabel : NEXT, size: Size.Medium, theme: Theme.Primary, icon: this.props.showNextIcon ? "arrowNext" : "", iconAlign: "right", disabled: this.props.disableNext, loading: this.props.loading, onClick: this.props.onNextClick ||
                        (function () {
                            /* noop */
                        }) })))));
    };
