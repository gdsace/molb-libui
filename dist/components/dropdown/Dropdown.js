    ...
    Dropdown.prototype.render = function () {
        ...
        var customStyles = {
            container: function (base, state) {
                ...
                return __assign({}, base, { boxSizing: "border-box", borderRadius: state.isFocused ? "3px 3px 0 0" : "3px", border: borderColor, "&:hover": {
        ...
        var dropdown = (React.createElement("div", { className: styles.field + " " + styles[this.props.size || Size.Large] },
            React.createElement(BaseDropdown, __assign({ components: __assign({}, baseComponents), styles: customStyles }, this.props)),
