...
describe("Card", function () {
    ...
    it("should render headerWrapper when have header in props", function () {
        var wrapper = mount(React.createElement(Card, { header: React.createElement("p", null, "header"), title: title, subtitle: subtitle, statusTheme: TagTheme.Green, onClick: noop }));
