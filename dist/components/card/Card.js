...
var Card = /** @class */ (function (_super) {
    ...
    Card.prototype.render = function () {
        ...
        return (React.createElement("div", { className: cardClass, onClick: this.handleOnClick },
            this.props.header && (React.createElement("div", { className: styles.headerWrapper }, this.props.header)),
            React.createElement("div", { className: styles.titleWithSupportingText },
