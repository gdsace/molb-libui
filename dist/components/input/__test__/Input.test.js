...
describe("Input", function () {
    ...
    it("should set type attribute to tel when type prop is PositiveIntegerText", function () {
        var component = Enzyme.shallow(React.createElement(Input, { value: "initial", onChange: jest.fn(), type: InputType.PositiveIntegerText }));
    ...
    it("should set type attribute to number when type prop is specified but not Text, Email or PositiveIntegerText", function () {
