...
var defaultChangesFilterRegexDict = (_a = {},
    ...
    _a[InputType.AlphaNumeric] = /^[a-zA-Z0-9]*$/,
    _a);
        ...
        return (React.createElement("div", { className: rootContainerClassname, "data-scrollpoint": !!this.props.label },
            ...
            React.createElement("div", { className: styles.inlineWrapper },
                React.createElement("div", { className: styles.inline },
                    this.props.isUncontrolled === true ? (React.createElement("input", { name: this.props.name, ref: this.props.uncontrolledRef, disabled: this.props.disabled, defaultValue: this.props.uncontrolledDefaultValue, className: styles.field + " " + size + " " + this.props.className + " " + (this.props.showError ? styles.error : "") + " " + (this.props.gaGreenStyling
                            ? styles.gaGreenStyling
                            : styles.defaultInput), type: this.getRawInputType(this.props.type), maxLength: this.props.maxLength, onChange: function (event) {
                        ...
                        }, placeholder: this.props.placeholder })) : (React.createElement("input", { name: this.props.name, disabled: this.props.disabled, className: styles.field + " " + size + " " + this.props.className + " " + (this.props.showError ? styles.error : "") + " " + (this.props.gaGreenStyling
                            ? styles.gaGreenStyling
                            : styles.defaultInput), value: this.props.value, type: this.getRawInputType(this.props.type), maxLength: this.props.maxLength, onChange: this.handleOnChange, onBlur: function () {
                            if (_this.props.onBlur) {
                                _this.props.onBlur();
                            }
                        }, onKeyPress: function (event) {
