...
var Tabs = /** @class */ (function (_super) {
    ...
    Tabs.prototype.render = function () {
        ...
        var _a = this.props, list = _a.list, leftNode = _a.leftNode, customizedTabComponent = _a.customizedTabComponent;
        ...
        return (React.createElement("div", { className: styles.tab },
            React.createElement("div", { className: styles.tabsBarContainer },
                React.createElement("div", { className: classnames(styles.tabsBarContent, this.props.tabsBarContentStyle) },
                    ...
                    React.createElement("div", { className: styles.tabItems }, list.map(function (item, index) {
                        return customizedTabComponent ? (React.cloneElement(customizedTabComponent, {
                            onClick: _this.tabItemClick(index),
                            key: index
                        })) : (React.createElement("div", { key: index, onClick: _this.tabItemClick(index), className: (currentIndex === index ? styles.activeItem : "") + " " + styles.item },
