...
describe("Inline notification", function () {
    it("should render warning notification success", function () {
        var wrapper = shallow(React.createElement(InlineNotification, { text: "this is warning text", theme: NotificationTheme.Warning }));
    ...
    it("should render error notification success", function () {
        var wrapper = shallow(React.createElement(InlineNotification, { text: "this is error text", theme: NotificationTheme.Error }));
...
//# sourceMappingURL=inlineNotification.test.js.map