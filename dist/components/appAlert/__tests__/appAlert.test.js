...
describe("App-level alert", function () {
    ...
    it("should render textInBold", function () {
        var wrapper = shallow(React.createElement(AppAlert, { text: "this is a bold bold bold text", textToBold: "bold", theme: AppAlertTheme.Informational }));
