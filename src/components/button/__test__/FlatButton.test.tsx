...
describe("FlatButton", () => {
  it("should render the icon with label", () => {
    const wrapper = mount(<FlatButton label="test" onClick={noop} iconType="close" />);
  ...
  it("should render disabled theme", () => {
    const wrapper = mount(<FlatButton label="test" onClick={noop} iconType="close" disabled={true} />);
    const buttonContent = wrapper.find(".rootContainer");
